...
parser.add_argument('--train-img-dir', type=str, help='Path to ImageNet training images')
parser.add_argument('--train-out', type=str, help= 'Path to output training lmdb dataset')
parser.add_argument('--val-img-dir', type=str, help= 'Path to ImageNet validation images')
parser.add_argument('--val-out', type=str, help= 'Path to output validation lmdb dataset')
