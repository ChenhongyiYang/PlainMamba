...
from mmcls.plain_mamba_dev.runner.amp_runner import AmpIterBasedRunner, AmpEpochBasedRunner, AutoAmpEpochBasedRunner
...
def main():
    ...
    _, world_size = get_dist_info()
    if cfg.get('base_lr', False):
        cfg.optimizer.lr = cfg.base_lr * float(cfg.samples_per_gpu) * float(world_size) / float(cfg.base_bs)
